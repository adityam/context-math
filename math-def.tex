...
\def\mathopwithlimits#1#2{\mathop{#1{#2}}\limits}
...
\ifx\{\undefined\else \unexpanded\def\{{\mathortext\lbrace\letterleftbrace } \fi
\ifx\}\undefined\else \unexpanded\def\}{\mathortext\rbrace\letterrightbrace} \fi
